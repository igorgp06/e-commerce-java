...
public class PessoaClienteController {
    ...
    public List<Pessoa> findAll() {
        return pessoaClienteService.findAll();
    }
    ...
    @PutMapping("/{id}")
    public Pessoa update(@PathVariable("id") Long id, @Valid @RequestBody PessoaClienteRequestDTO pessoaDTO) {
        return pessoaClienteService.change(id, pessoaDTO);
    }
